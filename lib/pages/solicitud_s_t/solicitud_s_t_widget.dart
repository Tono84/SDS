...
import 'solicitud_s_t_model.dart';
export 'solicitud_s_t_model.dart';

class SolicitudSTWidget extends StatefulWidget {
  const SolicitudSTWidget({Key? key}) : super(key: key);

  @override
  _SolicitudSTWidgetState createState() => _SolicitudSTWidgetState();
}

class _SolicitudSTWidgetState extends State<SolicitudSTWidget> {
  late SolicitudSTModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SolicitudSTModel());

    _model.txtSoController ??= TextEditingController();
    _model.txtSoFocusNode ??= FocusNode();
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<RequestsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<RequestsRecord> solicitudSTRequestsRecordList = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).secondaryBackground,
          appBar: AppBar(
                        ...
                        Expanded(
                          child: Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                8.0, 0.0, 8.0, 0.0),
                            child: TextFormField(
                              controller: _model.txtSoController,
                              focusNode: _model.txtSoFocusNode,
                              autofocus: true,
                              obscureText: false,
                              decoration: InputDecoration(
                                labelText: 'Digite el sistema Operativo ',
                              ...
                              validator: _model.txtSoControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                        ),
                                  ...
                                  children: [
                                    Expanded(
                                      child: FFButtonWidget(
                                        ...
                                        text:
                                            'SELECCIONES DÍA Y HORA DE RECOLECCIÓN',
                                    ...
                                    onPressed: () async {
                                      ...
                                      await RequestsRecord.collection
                                          ...
                                          .set(createRequestsRecordData(
                                            so: _model.txtSoController.text,
                                            marca:
                                                _model.txtMarcaController.text,
                                            tipoComputadora:
                                                _model.txtCompuController.text,
                                            tipoSoporte:
                                                _model.txtTipoSController.text,
                                            descripcion: _model
                                                .txtDescripController.text,
                                            estado: 'Pendiente',
